...
import { StructureModuleGpu, type StructureModuleWeights } from "../src/structure/module.js";
...
describe.skipIf(!enabled)("complete AlphaFold structure module WebGPU", () => {
  ...
  it("matches official final representation and atom positions", async () => {
    ...
    const p = async (map: ParameterMap, module: string, name: string): Promise<Float32Array> => {
    ...
    const weights: StructureModuleWeights = {
      initialize: {
