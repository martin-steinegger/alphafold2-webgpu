import type { TriangleMultiplicationInput } from "./types.js";
...
export function triangleMultiplicationOutgoingReference(input: TriangleMultiplicationInput): Float32Array {
