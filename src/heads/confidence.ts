...
export class ConfidenceHeadsGpu {
  ...
  async run(
    ...
    const tensors = [lddtWeights.normScale, lddtWeights.normOffset, lddtWeights.act0Weight,
      ...
      lddtWeights.logitsBias, paeWeights.logitsWeight, paeWeights.logitsBias] as const;
    ...
    try {
      ...
      const dispatch = (pipeline: GPUComputePipeline, buffers: readonly AllocatedGpuBuffer[], x: number, y = 1) => {
      ...
      const linearDispatch = (source: AllocatedGpuBuffer, parameter: AllocatedGpuBuffer,
