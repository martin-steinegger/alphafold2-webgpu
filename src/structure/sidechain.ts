...
export interface SidechainWeights {
  readonly inputWeight: Float32Array;
  readonly inputBias: Float32Array;
  readonly initialInputWeight: Float32Array;
  readonly initialInputBias: Float32Array;
  readonly residual1Weights: readonly [Float32Array, Float32Array];
  readonly residual1Biases: readonly [Float32Array, Float32Array];
  readonly residual2Weights: readonly [Float32Array, Float32Array];
  readonly residual2Biases: readonly [Float32Array, Float32Array];
  readonly angleWeight: Float32Array;
  readonly angleBias: Float32Array;
}

export interface SidechainAnglesResult {
...
export class SidechainAnglesGpu {
  ...
  async run(
    ...
    initialActivations: Float32Array,
    length: number,
    inputChannels: number,
    hiddenChannels: number,
    weightsValue: SidechainWeights,
  ): Promise<SidechainAnglesResult> {
