...
export interface StructurePostAttentionWeights {
  readonly attentionNormScale: Float32Array;
  readonly attentionNormOffset: Float32Array;
  readonly transitionWeights: readonly [Float32Array, Float32Array, Float32Array];
  readonly transitionBiases: readonly [Float32Array, Float32Array, Float32Array];
  readonly transitionNormScale: Float32Array;
  readonly transitionNormOffset: Float32Array;
  readonly affineWeight: Float32Array;
  readonly affineBias: Float32Array;
}

export interface StructurePostAttentionInput {
  readonly activations: Float32Array;
  readonly attentionUpdate: Float32Array;
  readonly affine: Float32Array;
  readonly length: number;
  readonly channels: number;
  readonly weights: StructurePostAttentionWeights;
}

export interface StructurePostAttentionResult {
  readonly activations: Float32Array;
  readonly affine: Float32Array;
...
function pack(input: StructurePostAttentionInput): { data: Float32Array; offsets: readonly number[] } {
...
function normParams(rows: number, channels: number, scale: number, offset: number): Uint8Array {
